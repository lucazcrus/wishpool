...
var require_react_dom_production = __commonJS({
  "node_modules/react-dom/cjs/react-dom.production.js"(exports) {
    ...
    var ReactSharedInternals = React42.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;
...
var require_react_dom_client_production = __commonJS({
  "node_modules/react-dom/cjs/react-dom-client.production.js"(exports) {
    ...
    var isomorphicReactPackageVersion$jscomp$inline_1840 = React42.version;
...
var require_use_sync_external_store_shim_production = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.production.js"(exports) {
    ...
    var objectIs = "function" === typeof Object.is ? Object.is : is;
    var useState18 = React42.useState;
    var useEffect19 = React42.useEffect;
    var useLayoutEffect6 = React42.useLayoutEffect;
    var useDebugValue = React42.useDebugValue;
...
var LogOut = createLucideIcon("log-out", __iconNode5);
...
var Logo_App_default = 'data:image/svg+xml,<svg width="40" height="32" viewBox="0 0 40 32" fill="none" xmlns="http://www.w3.org/2000/svg">%0A<path d="M20.8119 5.39408C20.8119 6.77094 20.3211 7.96153 19.3394 8.96583C18.3577 9.95394 16.926 10.6667 15.0445 11.104C16.0589 11.3794 16.8279 11.833 17.3514 12.4647C17.875 13.0802 18.1368 13.793 18.1368 14.6029C18.1368 15.8826 17.7278 16.9922 16.9097 17.9317C16.108 18.8712 14.9299 19.6001 13.3756 20.1185C11.8212 20.6206 9.94783 20.8717 7.75538 20.8717C6.9373 20.8717 6.28284 20.8474 5.79199 20.7988C5.77563 21.2523 5.57929 21.5925 5.20298 21.8193C4.82666 22.0461 4.344 22.1595 3.75498 22.1595C3.16596 22.1595 2.75692 22.0299 2.52786 21.7707C2.31516 21.5115 2.22517 21.1309 2.2579 20.6287C2.40515 18.3609 2.69148 15.9879 3.11688 13.5095C3.54228 11.0149 4.08221 8.60947 4.73667 6.29309C4.8512 5.88813 5.08027 5.60466 5.42386 5.44267C5.76745 5.28069 6.21739 5.1997 6.77369 5.1997C7.77174 5.1997 8.27077 5.47507 8.27077 6.02582C8.27077 6.25259 8.22169 6.51177 8.12352 6.80334C7.69812 8.06682 7.27272 9.78385 6.84732 11.9544C6.42191 14.1088 6.11923 16.166 5.93925 18.126C6.7246 18.1908 7.3627 18.2232 7.85355 18.2232C10.1442 18.2232 11.8212 17.8993 12.8847 17.2513C13.9646 16.5872 14.5045 15.7449 14.5045 14.7244C14.5045 14.0116 14.1937 13.4123 13.5719 12.9263C12.9665 12.4404 11.9439 12.1731 10.5041 12.1245C10.1769 12.1083 9.94783 12.0273 9.81694 11.8815C9.68605 11.7358 9.6206 11.5009 9.6206 11.1769C9.6206 10.7072 9.71877 10.3265 9.91511 10.0349C10.1114 9.74336 10.4714 9.58947 10.995 9.57327C12.1566 9.54088 13.2038 9.37079 14.1364 9.06302C15.0854 8.75525 15.8298 8.32599 16.3697 7.77525C16.9097 7.2083 17.1796 6.55227 17.1796 5.80714C17.1796 4.86763 16.7133 4.1306 15.7807 3.59605C14.8481 3.04531 13.4165 2.76993 11.4858 2.76993C9.73513 2.76993 8.04171 2.99671 6.40555 3.45027C4.7694 3.88762 3.37866 4.44647 2.23335 5.1268C1.70978 5.43457 1.26802 5.58846 0.908067 5.58846C0.613559 5.58846 0.384497 5.49127 0.220881 5.29689C0.073627 5.08631 0 4.82713 0 4.51936C0 4.1144 0.0818078 3.76614 0.245423 3.47456C0.425401 3.18299 0.84262 2.85092 1.49708 2.47836C2.87145 1.70084 4.48307 1.09339 6.33193 0.656037C8.18078 0.218679 10.0705
38.8711 10.4237ZM34.4534 18.612C34.8297 18.612 35.1897 18.3852 35.5333 17.9317C35.8769 17.4781 36.1223 16.8302 36.2696 15.9879L37.0549 11.833C36.3841 11.8492 35.7624 12.1083 35.1897 12.6105C34.617 13.0964 34.1589 13.7444 33.8153 14.5543C33.4717 15.3642 33.2999 16.2227 33.2999 17.1298C33.2999 17.632 33.3981 18.0046 33.5944 18.2475C33.8071 18.4905 34.0935 18.612 34.4534 18.612ZM32.4164 29.6431C32.8255 29.6431 33.2836 29.1572 33.7908 28.1853C34.3144 27.2134 34.8134 25.6664 35.2879 23.5444C34.028 24.6135 33.12 25.5773 32.5637 26.4358C32.0074 27.2944 31.7292 28.0476 31.7292 28.6955C31.7292 28.9709 31.7783 29.1977 31.8765 29.3759C31.991 29.554 32.171 29.6431 32.4164 29.6431Z" fill="%23FC4E23"/>%0A</svg>%0A';
...
function createSlot2(ownerName) {
  ...
  const Slot22 = React8.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React8.isValidElement(newElement) ? React8.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var DismissableLayerBranch = React18.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Primitive2.div, { ...props, ref: composedRefs });
});
...
var FocusScope = React19.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(Primitive2.div, { tabIndex: -1, ...scopeProps, ref: composedRefs, onKeyDown: handleKeyDown });
});
...
var Portal = React20.forwardRef((props, forwardedRef) => {
  ...
  return container ? import_react_dom.default.createPortal(/* @__PURE__ */ (0, import_jsx_runtime15.jsx)(Primitive2.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
var MenuGroup = React38.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Primitive2.div, { role: "group", ...groupProps, ref: forwardedRef });
  }
);
...
var MenuLabel = React38.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime19.jsx)(Primitive2.div, { ...labelProps, ref: forwardedRef });
  }
);
...
var DropdownMenuPortal = (props) => {
  ...
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(Portal2, { ...menuScope, ...portalProps });
};
...
var NAME3 = "Label";
var Label2 = React40.forwardRef((props, forwardedRef) => {
...
var Select = (props) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(Root22, { ...popperScope, children: /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)(
    SelectProvider,
    {
      ...
      disabled,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(Collection3.Provider, { scope: __scopeSelect, children: /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
  ...
  (props, forwardedRef) => {
    ...
    if (!context.open) {
      ...
      return frag ? ReactDOM5.createPortal(
        /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(SelectContentProvider, { scope: props.__scopeSelect, children: /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(Collection3.Slot, { scope: props.__scopeSelect, children: /* @__PURE__ */ (0, import_jsx_runtime22.jsx)("div", { children: props.children }) }) }),
        frag
      ) : null;
    }
...
var SelectContentImpl = React41.forwardRef(
  (props, forwardedRef) => {
    ...
    useFocusGuards();
    const focusFirst4 = React41.useCallback(
      (candidates) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
      SelectContentProvider,
      {
        ...
        isPositioned,
        searchRef,
        children: /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(Combination_default, { as: Slot3, allowPinchZoom: true, children: /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
          FocusScope,
          {
            asChild: true,
...
var SelectViewport = React41.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime22.jsxs)(import_jsx_runtime22.Fragment, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(Collection3.Slot, { scope: __scopeSelect, children: /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(
        Primitive2.div,
        {
...
function Button({
  ...
  const Comp = asChild ? dist_exports2.Root : "button";
...
function DropdownMenu2({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(Root23, { "data-slot": "dropdown-menu", ...props });
}
function DropdownMenuTrigger2({
  ...props
}) {
  return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(Trigger, { "data-slot": "dropdown-menu-trigger", ...props });
}
function DropdownMenuGroup2({
  ...props
}) {
  return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(Group2, { "data-slot": "dropdown-menu-group", ...props });
}
function DropdownMenuContent2({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(Portal22, { children: /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(
    Content22,
    {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(
    Item22,
    {
      ...
      className: cn(
        ...
        "relative flex cursor-default items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-none select-none data-[inset]:pl-8",
        className
      ),
      ...props
    }
...
var dropdownMenuItemVariants = cva(
  "focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
  {
    variants: {
      variant: {
        default: "",
        destructive: "text-destructive focus:bg-destructive/10 dark:focus:bg-destructive/20"
      }
    },
    defaultVariants: {
      variant: "default"
...
function Select2({ ...props }) {
  return /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(Root24, { "data-slot": "select", ...props });
}
function SelectValue2({ ...props }) {
  return /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(Value, { "data-slot": "select-value", ...props });
}
function SelectTrigger2({ className, children, ...props }) {
  return /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)(
    Trigger2,
    {
      "data-slot": "select-trigger",
      className: cn(
        "border-input data-[placeholder]:text-muted-foreground focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive dark:bg-input/30 dark:hover:bg-input/50 flex h-9 w-full items-center justify-between gap-2 rounded-md border bg-transparent px-3 py-2 text-sm whitespace-nowrap shadow-xs transition-[color,box-shadow] outline-hidden focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      ),
      ...props,
      children: [
        children,
        /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(Icon2, { asChild: true, children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(ChevronDown, { className: "size-4 opacity-50" }) })
      ]
    }
  );
}
function SelectContent2({ className, children, position = "popper", ...props }) {
  return /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(Portal3, { children: /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)(
    Content23,
    {
...
function SelectItem2({ className, children, ...props }) {
  return /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)(
    Item3,
    {
      ...
      ...props,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime27.jsx)("span", { className: "absolute right-2 flex size-3.5 items-center justify-center", children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(ItemIndicator2, { children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(Check, { className: "size-4" }) }) }),
...
function SelectScrollUpButton2({ className, ...props }) {
  return /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(ScrollUpButton, { "data-slot": "select-scroll-up-button", className: cn("flex cursor-default items-center justify-center py-1", className), ...props, children: /* @__PURE__ */ (0, import_jsx_runtime27.jsx)(ChevronUp, { className: "size-4" }) });
}
...
var COMPOSER_INPUT_CLASS = "h-10 rounded-md border-[#e2e8f0] px-3 text-sm text-slate-950 focus-visible:border-black";
var COMPOSER_SELECT_TRIGGER_CLASS = "h-10 rounded-md border-[#e2e8f0] px-3 text-sm font-normal text-slate-950 focus-visible:border-black hover:bg-white";
...
async function fetchSupabaseUser(accessToken) {
  ...
  if (!response.ok) {
    throw new Error("N\xE3o foi poss\xEDvel carregar usu\xE1rio autenticado.");
  }
...
async function signInWithPassword(email, password) {
  ...
  if (!response.ok) {
    ...
    throw new Error(payload.error_description || payload.msg || "Credenciais inv\xE1lidas.");
  }
  return response.json();
}
async function signInWithGoogle() {
  if (typeof chrome.identity?.launchWebAuthFlow !== "function") {
    throw new Error(
      "API de identidade indispon\xEDvel. Recarregue a extens\xE3o em chrome://extensions e tente novamente."
    );
  }
    ...
    chrome.identity.launchWebAuthFlow({ url: authUrl, interactive: true }, (responseUrl) => {
      ...
      try {
        ...
        if (!accessToken) {
          reject(
            new Error(
              "Token n\xE3o encontrado. Adicione o Redirect URI no Supabase (veja o console)."
            )
          );
          return;
        }
...
function PopupApp() {
  ...
  const [categories, setCategories] = (0, import_react7.useState)(DEFAULT_CATEGORIES);
  const [selectedCategory, setSelectedCategory] = (0, import_react7.useState)(DEFAULT_CATEGORIES[0]);
  ...
  const [isLoginBusy, setIsLoginBusy] = (0, import_react7.useState)(false);
  const [isCaptureBusy, setIsCaptureBusy] = (0, import_react7.useState)(false);
  const [isAddedFeedback, setIsAddedFeedback] = (0, import_react7.useState)(false);
  const [feedbackLink, setFeedbackLink] = (0, import_react7.useState)(null);
  const [frameHeight, setFrameHeight] = (0, import_react7.useState)(void 0);
  const [previewFaviconSrc, setPreviewFaviconSrc] = (0, import_react7.useState)("");
  const [loginStatus, setLoginStatus] = (0, import_react7.useState)({ message: "", type: "info" });
  const [captureStatus, setCaptureStatus] = (0, import_react7.useState)({ message: "", type: "info" });
  const frameRef = (0, import_react7.useRef)(null);
  const frameContentRef = (0, import_react7.useRef)(null);
  ...
  (0, import_react7.useEffect)(() => {
    ...
    async function bootstrap() {
      ...
      setSelectedCategory(
        (prev) => prev === NEW_CATEGORY_VALUE || normalized.includes(prev) ? prev : normalized[0] ?? "Todos"
      );
  ...
  const appOrigin = (0, import_react7.useMemo)(() => resolveAppOrigin(activeTab?.url), [activeTab?.url]);
  ...
  async function handleCaptureSubmit(event) {
    ...
    try {
      ...
      if (!payload.name || !payload.category) {
        setCaptureStatus({ message: "Preencha t\xEDtulo e categoria.", type: "error" });
        return;
      }
  ...
  const currentRowUrl = isAddedFeedback ? feedbackLink?.url || activeTab?.url || "-" : activeTab?.url || "-";
  (0, import_react7.useEffect)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
    "main",
    {
      ...
      style: {
        height: isLogged && frameHeight ? `${frameHeight}px` : void 0,
        overflow: "hidden",
        transition: "height 350ms cubic-bezier(0.34, 1.56, 0.64, 1), padding 200ms ease-out, box-shadow 150ms ease-out"
      },
      children: !isLogged ? /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("section", { "aria-label": "Login", className: "min-h-[580px]", children: [
        /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("header", { className: "flex items-center justify-between border-b border-slate-200 px-5 py-4", children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("img", { src: Logo_App_default, alt: "Bag", className: "h-8 w-auto shrink-0" }) }),
        /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("div", { className: "px-5 pb-5 pt-6", children: [
          /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("h1", { className: "m-0 text-4xl font-bold tracking-tight", children: "Fazer login" }),
          /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("p", { className: "mt-2 text-sm text-slate-600", children: "Entre na sua conta para salvar seus links." }),
          /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("form", { onSubmit: handlePasswordLogin, className: "mt-5 grid gap-4", children: [
            /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("div", { className: "grid gap-2", children: [
              /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(Label3, { htmlFor: "login-email", children: "Email" }),
            ...
            /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("div", { className: "grid gap-2", children: [
              /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(Label3, { htmlFor: "login-password", children: "Senha" }),
              /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
                Input,
                {
                  id: "login-password",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("div", { className: "flex flex-col gap-2", children: [
              /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(Button, { type: "submit", disabled: isLoginBusy, children: "Fazer login" }),
              /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(Button, { type: "button", variant: "outline", onClick: handleGoogleLogin, disabled: isLoginBusy, children: "Continuar com Google" })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("p", { className: statusClass(loginStatus.type), children: loginStatus.message })
          ] })
        ] })
      ] }) : /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("section", { ref: frameContentRef, "aria-label": "Adicionar link", children: [
        /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("header", { className: "flex items-center justify-between border-b border-slate-200 px-5 py-4", children: [
          /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("div", { className: "flex items-center gap-3", children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("img", { src: Logo_App_default, alt: "Bag", className: "h-8 w-auto shrink-0" }) }),
          /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(DropdownMenu2, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(DropdownMenuTrigger2, { asChild: true, children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(Button, { variant: "ghost", size: "icon", className: "rounded-full", children: /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(Avatar2, { children: [
              /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(AvatarImage2, { src: "", alt: session?.email || "Usu\xE1rio" }),
              /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(AvatarFallback2, { className: "bg-amber-400 text-slate-950", children: avatarInitial })
            ] }) }) }),
            /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(DropdownMenuContent2, { className: "w-44", align: "end", children: [
              /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(DropdownMenuGroup2, { children: /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(DropdownMenuItem2, { onSelect: () => void chrome.tabs.create({ url: profileUrl }), children: [
                /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(Settings, { className: "size-4" }),
                "Configura\xE7\xF5es"
              ] }) }),
              /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(DropdownMenuSeparator2, {}),
              /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(DropdownMenuGroup2, { children: /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(DropdownMenuItem2, { variant: "destructive", onSelect: () => void handleLogout(), children: [
                /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(LogOut, { className: "size-4" }),
                "Deslogar"
              ] }) })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("div", { className: "px-5 pb-5 pt-4", children: [
          /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("div", { className: "mb-4 flex items-center gap-3", children: [
            isAddedFeedback ? /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("span", { className: "inline-flex size-8 min-w-8 shrink-0 items-center justify-center rounded-[8px] bg-[#289717] text-white", children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(Check, { className: "size-5 stroke-[2.5]" }) }) : /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("span", { className: "inline-flex size-8 min-w-8 shrink-0 items-center justify-center rounded-[8px] border border-slate-200 bg-white", children: previewFaviconSrc ? /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
              "img",
              {
                alt: "Favicon",
                width: "20",
            ...
            ) : /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(Globe, { className: "size-4 text-slate-500" }) }),
            /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("p", { className: "m-0 min-w-0 flex-1 truncate text-sm text-[#aaa]", children: currentRowUrl })
          ] }),
          isAddedFeedback ? /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("div", { className: "space-y-3 py-1", children: /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("div", { className: "flex items-center justify-end gap-2", children: [
            /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(Button, { type: "button", onClick: handleCreateNewLink, children: "Novo Link" }),
            /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(Button, { type: "button", variant: "outline", onClick: () => void chrome.tabs.create({ url: appUrl }), children: "Abrir app" })
          ] }) }) : /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("form", { onSubmit: handleCaptureSubmit, className: "grid gap-4", children: [
            /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("div", { className: "grid gap-2", children: [
              /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(Label3, { htmlFor: "capture-title", children: "T\xEDtulo" }),
              /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
                Input,
                {
                  id: "capture-title",
            ...
            /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("div", { className: "grid gap-2", children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(Select2, { value: selectedCategory, onValueChange: setSelectedCategory, children: [
                /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(SelectTrigger2, { className: COMPOSER_SELECT_TRIGGER_CLASS, children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(SelectValue2, { placeholder: "Selecione uma categoria" }) }),
                /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(SelectContent2, { children: [
                  categories.map((category) => /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(SelectItem2, { value: category, children: category }, category)),
                  /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(SelectItem2, { value: NEW_CATEGORY_VALUE, children: "+ Nova categoria" })
                ] })
              ] })
            ] }),
            selectedCategory === NEW_CATEGORY_VALUE && /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("div", { className: "grid gap-2", children: [
              /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(Label3, { htmlFor: "capture-new-category", children: "Nova categoria" }),
              /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(
                  Input,
                  {
                    ...
                    name: "newCategory",
                    className: COMPOSER_INPUT_CLASS,
                    placeholder: "Ex: T\xEAnis",
                    value: newCategory,
                    onChange: (e) => setNewCategory(e.target.value),
                    required: true
                  }
                ),
                /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(Button, { type: "button", variant: "outline", size: "icon", onClick: () => void handleCreateCategory(), children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(Plus, { className: "size-4" }) })
              ] })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("div", { className: "flex flex-col gap-2", children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)(Button, { type: "submit", disabled: isCaptureBusy, children: isCaptureBusy ? "Adicionando..." : "Adicionar link" }) })
          ] }),
          !isAddedFeedback && /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("div", { className: "mt-3", children: /* @__PURE__ */ (0, import_jsx_runtime28.jsx)("p", { className: statusClass(captureStatus.type), children: captureStatus.message }) })
        ] })
      ] })
    }
  );
...
if (rootEl) {
  (0, import_client.createRoot)(rootEl).render(/* @__PURE__ */ (0, import_jsx_runtime28.jsx)(PopupApp, {}));
}
